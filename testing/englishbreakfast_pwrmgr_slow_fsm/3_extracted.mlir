module {
  fsm.machine @pwrmgr_slow_fsm(%arg0: i1, %arg1: i1, %arg2: i1, %arg3: i1, %arg4: i1, %arg5: i1, %arg6: i1, %arg7: i1, %arg8: i1, %arg9: i1, %arg10: i1, %arg11: i1, %arg12: i1, %arg13: i1, %arg14: i1, %arg15: i1, %arg16: i1, %arg17: i1) -> (i1, i1, i2, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1) attributes {initialState = "state_0"} {
    ...
    fsm.state @state_0 output {
      ...
      verif.assert %3 : i1
      fsm.output %false, %false, %c0_i2, %false, %rst_req_o, %fsm_invalid_q, %usb_clk_en_q, %main_pd_n, %pwr_clamp_env, %pwr_clamp, %slow_clk_en, %core_clk_en, %io_clk_en, %usb_clk_en : i1, i1, i2, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1
    } transitions {
      fsm.transition @state_34 guard {
        ...
        %10 = comb.and %9, %8 : i1
        %11 = comb.or %usb_clk_en_q, %arg7 : i1
        %12 = comb.xor %7, %true : i1
        verif.assert %12 : i1
        fsm.update %u_usb_clk_en2Fq_o, %11 : i1
