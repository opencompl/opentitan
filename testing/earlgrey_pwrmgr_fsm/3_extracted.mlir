module {
  fsm.machine @pwrmgr_fsm(%arg0: i1, %arg1: i1, %arg2: i1, %arg3: i1, %arg4: i2, %arg5: i1, %arg6: i1, %arg7: i1, %arg8: i6, %arg9: i1, %arg10: i1, %arg11: i2, %arg12: i2, %arg13: i1, %arg14: i1, %arg15: i1, %arg16: i1, %arg17: i1, %arg18: i1, %arg19: i1, %arg20: i4, %arg21: i4, %arg22: i1, %arg23: i4, %arg24: i4) -> (i1, i1, i1, i1, i1, i1, i1, i1, i1, i2, i2, i5, i2, i1, i1, i1, i1, i1, i1, i1, i1, i4) attributes {initialState = "state_0"} {
    ...
    fsm.state @state_0 output {
      ...
      fsm.output %false, %false, %false, %arg15, %false, %false, %false, %false, %false, %rst_lc_req, %rst_sys_req, %rstreqs, %reset_cause, %main_ip_clk_en, %io_ip_clk_en, %usb_ip_clk_en, %u_reg_otp_init2Fq_o, %u_reg_lc_init2Fq_o, %false, %strap_sampled_o, %true, %c-6_i4 : i1, i1, i1, i1, i1, i1, i1, i1, i1, i2, i2, i5, i2, i1, i1, i1, i1, i1, i1, i1, i1, i4
    } transitions {
