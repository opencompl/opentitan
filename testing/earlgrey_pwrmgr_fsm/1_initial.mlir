module {
  hw.module @pwrmgr_fsm(in %clk_i : i1, in %rst_ni : i1, in %clk_slow_i : i1, in %rst_slow_ni : i1, in %req_pwrup_i : i1, in %pwrup_cause_i : i2, out ack_pwrup_o : i1, out req_pwrdn_o : i1, in %ack_pwrdn_i : i1, in %low_power_entry_i : i1, in %main_pd_ni : i1, in %reset_reqs_i : i6, in %fsm_invalid_i : i1, out clr_slow_req_o : i1, in %usb_ip_clk_en_i : i1, out usb_ip_clk_status_o : i1, out wkup_o : i1, out fall_through_o : i1, out abort_o : i1, out clr_hint_o : i1, out clr_cfg_lock_o : i1, out pwr_rst_o : !hw.struct<rst_lc_req: i2, rst_sys_req: i2, rstreqs: i5, reset_cause: i2>, in %pwr_rst_i : !hw.struct<rst_lc_src_n: i2, rst_sys_src_n: i2>, out ips_clk_en_o : !hw.struct<main_ip_clk_en: i1, io_ip_clk_en: i1, usb_ip_clk_en: i1>, in %clk_en_status_i : !hw.struct<main_status: i1, io_status: i1, usb_status: i1>, out otp_init_o : i1, in %otp_done_i : i1, in %otp_idle_i : i1, out lc_init_o : i1, in %lc_done_i : i1, in %lc_idle_i : i1, in %lc_dft_en_i : i4, in %lc_hw_debug_en_i : i4, in %flash_idle_i : i1, in %rom_ctrl_done_i : i4, in %rom_ctrl_good_i : i4, out strap_o : i1, out strap_sampled_o : i1, out low_power_o : i1, out fetch_en_o : i4) {
    ...
    %u_state_regs.state_o = hw.instance "u_state_regs" @prim_sparse_fsm_flop(clk_i: %clk_i: i1, rst_ni: %rst_ni: i1, state_i: %96#9: i12) -> (state_o: i12)
    ...
    %96:19 = llhd.combinational -> i1, i1, i1, i1, i1, i1, i1, i1, i1, i12, i1, i1, i1, i1, i2, i2, i2, i1, i4 {
      %99 = comb.icmp ceq %u_state_regs.state_o, %c55_i12 : i12
    ...
    ^bb3(%108: i1, %109: i1, %110: i1, %111: i1, %112: i1, %113: i2, %114: i2, %115: i2, %116: i12, %117: i1, %118: i1):  // 5 preds: ^bb2, ^bb6, ^bb7, ^bb24, ^bb26
      cf.cond_br %108, ^bb32(%109, %110, %false, %false, %false, %false, %false, %false, %false, %ack_pwrup_q, %111, %reset_ongoing_q, %112, %113, %114, %115, %low_power_q, %u_fetch_en.lc_en_o, %116 : i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i2, i2, i2, i1, i4, i12), ^bb32(%109, %117, %false, %false, %false, %false, %false, %false, %false, %ack_pwrup_q, %118, %reset_ongoing_q, %112, %113, %114, %115, %low_power_q, %u_fetch_en.lc_en_o, %u_state_regs.state_o : i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i2, i2, i2, i1, i4, i12)
    ^bb4:  // pred: ^bb2
      %119 = comb.icmp ceq %u_state_regs.state_o, %c-1600_i12 : i12
    ...
    ^bb6:  // pred: ^bb4
      %121 = comb.icmp ceq %u_state_regs.state_o, %c-94_i12 : i12
    ...
    ^bb7:  // pred: ^bb6
      %122 = comb.icmp ceq %u_state_regs.state_o, %c-1453_i12 : i12
    ...
    ^bb8:  // pred: ^bb7
      %123 = comb.icmp ceq %u_state_regs.state_o, %c168_i12 : i12
    ...
    ^bb9:  // pred: ^bb8
      ...
      cf.cond_br %126, ^bb10, ^bb32(%false, %false, %false, %false, %false, %false, %false, %false, %false, %124, %req_pwrdn_q, %reset_ongoing_q, %ip_clk_en_q, %rst_lc_req_q, %rst_sys_req_q, %reset_cause_q, %low_power_q, %u_fetch_en.lc_en_o, %u_state_regs.state_o : i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i2, i2, i2, i1, i4, i12)
    ^bb10:  // pred: ^bb9
    ...
    ^bb11:  // pred: ^bb8
      %129 = comb.icmp ceq %u_state_regs.state_o, %c-966_i12 : i12
    ...
    ^bb13:  // pred: ^bb11
      %131 = comb.icmp ceq %u_state_regs.state_o, %c1523_i12 : i12
    ...
    ^bb19:  // pred: ^bb17
      %144 = comb.icmp ceq %u_state_regs.state_o, %c1744_i12 : i12
    ...
    ^bb21:  // pred: ^bb19
      %146 = comb.icmp ceq %u_state_regs.state_o, %c-1671_i12 : i12
    ...
    ^bb23:  // pred: ^bb21
      %148 = comb.icmp ceq %u_state_regs.state_o, %c1423_i12 : i12
    ...
    ^bb26:  // pred: ^bb23
      %168 = comb.icmp ceq %u_state_regs.state_o, %c-375_i12 : i12
    ...
    ^bb27:  // pred: ^bb26
      %169 = comb.icmp ceq %u_state_regs.state_o, %c778_i12 : i12
    ...
    ^bb28:  // pred: ^bb27
      %170 = comb.icmp ceq %u_state_regs.state_o, %c1647_i12 : i12
    ...
    ^bb30:  // pred: ^bb28
      %175 = comb.icmp ceq %u_state_regs.state_o, %c-4_i12 : i12
      cf.cond_br %175, ^bb31, ^bb32(%false, %false, %false, %false, %false, %false, %false, %false, %false, %ack_pwrup_q, %req_pwrdn_q, %reset_ongoing_q, %false, %c-1_i2, %c-1_i2, %reset_cause_q, %low_power_q, %u_fetch_en.lc_en_o, %u_state_regs.state_o : i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i2, i2, i2, i1, i4, i12)
    ^bb31:  // pred: ^bb30
