module {
  fsm.machine @pwrmgr_slow_fsm(%arg0: i1, %arg1: i1, %arg2: i1, %arg3: i1, %arg4: i1, %arg5: i1, %arg6: i1, %arg7: i1, %arg8: i1, %arg9: i1, %arg10: i1, %arg11: i1, %arg12: i1, %arg13: i1, %arg14: i1, %arg15: i1, %arg16: i1, %arg17: i1) -> (i1, i1, i2, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1) attributes {initialState = "state_34"} {
    ...
    fsm.state @state_34 output {
      ...
      verif.assert %3 : i1
      fsm.output %req_pwrup_q, %cause_toggle_q, %cause_q, %ack_pwrdn_q, %rst_req_o, %fsm_invalid_q, %usb_clk_en_q, %main_pd_n, %pwr_clamp_env, %pwr_clamp, %slow_clk_en, %core_clk_en, %io_clk_en, %usb_clk_en : i1, i1, i2, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1, i1
    } transitions {
      fsm.transition @state_431 guard {
        ...
        fsm.update %usb_clk_en_q, %3 : i1
        fsm.update %cause_q, %c0_i2 : i2
        %17 = comb.or %fsm_invalid_q, %0 : i1
        %18 = comb.or %fsm_invalid_q, %1 : i1
        fsm.update %io_clk_en_q, %18 : i1
        fsm.update %main_clk_en_q, %17 : i1
      }
    }
    fsm.state @state_431 output {
      ...
      fsm.transition @state_431 guard {
        ...
        %6 = comb.and %5, %pwr_clamp_env_q : i1
        %7 = comb.or %u_main_pok_sync2Fu_sync_22Fq_o, %mon_main_pok : i1
        %8 = comb.and %mon_main_pok, %4 : i1
        ...
        %14 = comb.or %fsm_invalid_q, %0 : i1
        %15 = comb.or %fsm_invalid_q, %1 : i1
        fsm.update %io_clk_en_q, %15 : i1
        fsm.update %main_clk_en_q, %14 : i1
      }
    ...
    fsm.state @state_700 output {
      ...
      fsm.transition @state_700 guard {
        ...
        %4 = comb.mux %2, %c218_i10, %c-324_i10 : i10
        %5 = comb.and %mon_main_pok, %3 : i1
        %6 = comb.xor %5, %true : i1
        verif.assert %6 : i1
        %7 = comb.extract %4 from 5 : (i10) -> i2
        %8 = comb.extract %4 from 9 : (i10) -> i1
        %9 = comb.extract %4 from 1 : (i10) -> i2
    ...
    fsm.state @state_218 output {
      ...
      fsm.transition @state_992 guard {
        ...
        %3 = comb.mux %1, %c-32_i10, %c218_i10 : i10
        %4 = comb.and %mon_main_pok, %2 : i1
        %5 = comb.xor %4, %true : i1
        verif.assert %5 : i1
        %6 = comb.extract %3 from 8 : (i10) -> i2
        %7 = comb.extract %3 from 3 : (i10) -> i3
        %8 = comb.extract %3 from 1 : (i10) -> i1
    ...
    fsm.state @state_891 output {
      ...
      fsm.transition @state_891 guard {
        ...
        %8 = comb.or %2, %7 : i1
        %9 = comb.and %4, %6, %8 : i1
        %10 = comb.or %fsm_invalid_q, %2 : i1
        %11 = comb.xor %arg8, %true : i1
        %12 = comb.xor %u_main_pok_sync2Fu_sync_22Fq_o, %true : i1
        %13 = comb.mux %9, %11, %pwr_clamp_env_q : i1
        %14 = comb.xor %pd_nq, %true : i1
        %15 = comb.and %14, %mon_main_pok : i1
        %16 = comb.xor %15, %true : i1
        %true_0 = hw.constant true
        %17 = comb.xor %15, %true_0 : i1
        %18 = comb.or %17, %16 : i1
        %19 = comb.and %18, %mon_main_pok : i1
        %20 = comb.and %mon_main_pok, %12 : i1
        %21 = comb.or %rst_req_o, %20 : i1
        %22 = comb.xor %arg6, %true : i1
        %23 = comb.and %22, %21 : i1
        %24 = comb.or %usb_clk_en_q, %arg7 : i1
        %25 = comb.xor %20, %true : i1
        verif.assert %25 : i1
        fsm.update %u_usb_clk_en2Fq_o, %24 : i1
        fsm.update %rst_req_o, %23 : i1
        fsm.update %mon_main_pok, %19 : i1
        fsm.update %usb_clk_en_q, %10 : i1
        fsm.update %pwr_clamp_env_q, %13 : i1
        %26 = comb.or %fsm_invalid_q, %0 : i1
        %27 = comb.or %fsm_invalid_q, %1 : i1
        fsm.update %io_clk_en_q, %27 : i1
        fsm.update %main_clk_en_q, %26 : i1
      }
    ...
    fsm.state @state_711 output {
      ...
      fsm.transition @state_711 guard {
        ...
        %21 = comb.or %fsm_invalid_q, %0 : i1
        %22 = comb.or %fsm_invalid_q, %1 : i1
        fsm.update %io_clk_en_q, %22 : i1
        fsm.update %main_clk_en_q, %21 : i1
      }
      fsm.transition @state_431 guard {
        %true = hw.constant true
        %0 = comb.or %arg2, %arg3 : i1
