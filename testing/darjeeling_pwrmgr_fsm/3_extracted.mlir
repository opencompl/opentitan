module {
  fsm.machine @pwrmgr_fsm(%arg0: i1, %arg1: i1, %arg2: i1, %arg3: i1, %arg4: i2, %arg5: i1, %arg6: i1, %arg7: i1, %arg8: i6, %arg9: i1, %arg10: i1, %arg11: i1, %arg12: i2, %arg13: i2, %arg14: i1, %arg15: i1, %arg16: i1, %arg17: i1, %arg18: i1, %arg19: i1, %arg20: i4, %arg21: i4, %arg22: i1, %arg23: i4, %arg24: i4) -> (i1, i1, i1, i1, i1, i1, i1, i1, i2, i2, i5, i2, i1, i1, i1, i1, i1, i1, i1, i4) attributes {initialState = "state_55"} {
    ...
    fsm.state @state_2766 output {
      ...
      fsm.transition @state_2766 guard {
        %c-1_i2 = hw.constant -1 : i2
        %0 = hw.struct_create (%arg14, %arg15) : !hw.struct<main_status: i1, io_status: i1>
        %1 = hw.struct_create (%ip_clk_en_q, %ip_clk_en_q) : !hw.struct<main_ip_clk_en: i1, io_ip_clk_en: i1>
        %2 = hw.bitcast %1 : (!hw.struct<main_ip_clk_en: i1, io_ip_clk_en: i1>) -> i2
        %3 = hw.bitcast %0 : (!hw.struct<main_status: i1, io_status: i1>) -> i2
        %4 = comb.and %2, %3 : i2
        %5 = comb.xor %2, %c-1_i2 : i2
        %6 = comb.or %4, %5 : i2
    ...
    fsm.state @state_2496 output {
      ...
      fsm.transition @state_4002 guard {
        %c-1_i2 = hw.constant -1 : i2
        %0 = comb.icmp eq %arg12, %c-1_i2 : i2
    ...
    fsm.state @state_4002 output {
      ...
      fsm.transition @state_4002 guard {
        ...
        fsm.update %u_reg_otp_init2Fq_o, %true_0 : i1
        fsm.update %strap_sampled_o, %6 : i1
        fsm.update %ext_rst_pending_q, %4 : i1
      }
      fsm.transition @state_3414 guard {
    ...
    fsm.state @state_168 output {
      ...
      fsm.transition @state_168 guard {
        ...
        %26 = comb.xor %ext_rst_pending_q, %true : i1
        %27 = comb.and %22, %25, %26 : i1
        %28 = comb.xor %27, %true : i1
        %c-88_i8 = hw.constant -88 : i8
        %c55_i8 = hw.constant 55 : i8
        %29 = comb.mux %28, %c-88_i8, %c55_i8 : i8
        %30 = comb.xor %24, %true : i1
        %31 = comb.extract %29 from 7 : (i8) -> i1
        %32 = comb.extract %29 from 0 : (i8) -> i5
        %33 = comb.concat %31, %32 : i1, i5
        %c-24_i6 = hw.constant -24 : i6
        %34 = comb.icmp eq %33, %c-24_i6 : i6
        %true_0 = hw.constant true
        %35 = comb.xor %24, %true_0 : i1
        %36 = comb.and %35, %34 : i1
        %37 = comb.or %30, %36 : i1
        %true_1 = hw.constant true
        %38 = comb.xor %arg9, %true_1 : i1
    ...
    fsm.state @state_3130 output {
      ...
      fsm.transition @state_3414 guard {
        ...
        %3 = comb.xor %1, %true : i1
        %4 = comb.and %3, %2 : i1
        %5 = comb.icmp eq %rst_sys_req_q, %c-1_i2 : i2
        %6 = comb.xor %5, %true : i1
        %7 = comb.xor %strap_sampled_o, %true : i1
        %false = hw.constant false
        %false_0 = hw.constant false
        fsm.update %u_reg_lc_init2Fq_o, %false_0 : i1
        fsm.update %u_reg_otp_init2Fq_o, %false : i1
        ...
        %8 = comb.and %6, %7 : i1
        %9 = comb.or %5, %7 : i1
        %10 = comb.mux bin %9, %8, %strap_sampled_o : i1
        fsm.update %strap_sampled_o, %10 : i1
      }
    ...
    fsm.state @state_868 output {
      ...
      fsm.transition @state_3414 guard {
        ...
        %1 = comb.xor %arg11, %true : i1
        %2 = comb.and %ext_rst_pending_q, %1, %ext_rst_req_q : i1
        %3 = comb.or %arg10, %ext_rst_pending_q : i1
    ...
    fsm.state @state_917 output {
      ...
      fsm.transition @state_1744 guard {
        ...
        %5 = comb.or %3, %4 : i1
        %6 = hw.bitcast %1 : (!hw.struct<main_ip_clk_en: i1, io_ip_clk_en: i1>) -> i2
        %7 = hw.bitcast %0 : (!hw.struct<main_status: i1, io_status: i1>) -> i2
        %8 = comb.xor %6, %c-1_i2 : i2
        %9 = comb.xor %ip_clk_en_q, %true : i1
        %10 = comb.xor %7, %c-1_i2 : i2
        %11 = comb.and %8, %10 : i2
        %12 = comb.or %11, %6 : i2
    ...
    fsm.state @state_1647 output {
      ...
      fsm.transition @state_4092 guard {
        ...
        %7 = comb.and %ext_rst_pending_q, %6, %ext_rst_req_q : i1
        %8 = comb.or %arg10, %ext_rst_pending_q : i1
        %9 = comb.xor %7, %true : i1
        %10 = comb.and %9, %8 : i1
        %11 = comb.icmp ne %rst_sys_req_q, %c-1_i2 : i2
        %12 = comb.and %11, %strap_sampled_o : i1
        %13 = comb.icmp ne %arg21, %c5_i4 : i4
        %14 = comb.and %4, %13 : i1
        %15 = comb.or %1, %2, %3, %5, %14 : i1
        %16 = comb.replicate %15 : (i1) -> i2
        %false = hw.constant false
        %false_0 = hw.constant false
        fsm.update %u_reg_lc_init2Fq_o, %false_0 : i1
        fsm.update %u_reg_otp_init2Fq_o, %false : i1
        fsm.update %strap_sampled_o, %12 : i1
        fsm.update %reset_cause_q, %c-2_i2 : i2
        fsm.update %rst_sys_req_q, %16 : i2
        fsm.update %rst_lc_req_q, %c-1_i2 : i2
        fsm.update %ext_rst_pending_q, %10 : i1
      }
      fsm.transition @state_3414 guard {
        fsm.return %arg9
      } action {
    ...
    fsm.state @state_4092 output {
      ...
      fsm.transition @state_4092 guard {
        ...
        %24 = comb.xor %ext_rst_pending_q, %true : i1
        %25 = comb.and %22, %23, %24 : i1
        %26 = comb.xor %25, %true : i1
        %27 = comb.mux %26, %c-4_i12, %c55_i12 : i12
        %28 = comb.extract %27 from 6 : (i12) -> i6
        %29 = comb.extract %27 from 0 : (i12) -> i2
        %30 = comb.extract %27 from 3 : (i12) -> i1
        %31 = comb.concat %28, %30, %29 : i6, i1, i2
        %c-4_i9 = hw.constant -4 : i9
        %32 = comb.icmp eq %31, %c-4_i9 : i9
        %true_0 = hw.constant true
        %33 = comb.xor %arg9, %true_0 : i1
    ...
    fsm.state @state_1423 output {
      ...
      fsm.transition @state_3721 guard {
        ...
        %5 = comb.icmp ne %rst_sys_req_q, %c-1_i2 : i2
        %6 = comb.and %5, %strap_sampled_o : i1
        %7 = comb.xor %arg7, %true : i1
        %8 = comb.replicate %7 : (i1) -> i2
        %false = hw.constant false
        %false_0 = hw.constant false
        fsm.update %u_reg_lc_init2Fq_o, %false_0 : i1
        fsm.update %u_reg_otp_init2Fq_o, %false : i1
        ...
        fsm.update %rst_sys_req_q, %8 : i2
        fsm.update %rst_lc_req_q, %8 : i2
        fsm.update %ext_rst_pending_q, %4 : i1
      }
      fsm.transition @state_3414 guard {
        fsm.return %arg9
