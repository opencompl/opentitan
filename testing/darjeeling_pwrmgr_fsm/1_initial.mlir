module {
  hw.module @pwrmgr_fsm(in %clk_i : i1, in %rst_ni : i1, in %clk_slow_i : i1, in %rst_slow_ni : i1, in %req_pwrup_i : i1, in %pwrup_cause_i : i2, out ack_pwrup_o : i1, out req_pwrdn_o : i1, in %ack_pwrdn_i : i1, in %low_power_entry_i : i1, in %main_pd_ni : i1, in %reset_reqs_i : i6, in %fsm_invalid_i : i1, out clr_slow_req_o : i1, out wkup_o : i1, out fall_through_o : i1, out abort_o : i1, out clr_hint_o : i1, out clr_cfg_lock_o : i1, in %int_reset_req_i : i1, in %ext_rst_ack_i : i1, out pwr_rst_o : !hw.struct<rst_lc_req: i2, rst_sys_req: i2, rstreqs: i5, reset_cause: i2>, in %pwr_rst_i : !hw.struct<rst_lc_src_n: i2, rst_sys_src_n: i2>, out ips_clk_en_o : !hw.struct<main_ip_clk_en: i1, io_ip_clk_en: i1>, in %clk_en_status_i : !hw.struct<main_status: i1, io_status: i1>, out otp_init_o : i1, in %otp_done_i : i1, in %otp_idle_i : i1, out lc_init_o : i1, in %lc_done_i : i1, in %lc_idle_i : i1, in %lc_dft_en_i : i4, in %lc_hw_debug_en_i : i4, in %flash_idle_i : i1, in %rom_ctrl_done_i : i4, in %rom_ctrl_good_i : i4, out strap_o : i1, out strap_sampled_o : i1, out low_power_o : i1, out fetch_en_o : i4) {
    ...
    %0 = hw.struct_create (%rst_lc_req_q, %rst_sys_req_q, %11, %c-1_i2) : !hw.struct<rst_lc_req: i2, rst_sys_req: i2, rstreqs: i5, reset_cause: i2>
    ...
    %ext_rst_req_q = seq.firreg %ext_rst_ack_i clock %7 reset async %8, %false : i1
    %ext_rst_pending_q = seq.firreg %6 clock %7 reset async %8, %false : i1
    %ip_clk_en_q = seq.firreg %false clock %7 reset async %8, %false : i1
    %rst_lc_req_q = seq.firreg %c-1_i2 clock %7 reset async %8, %c-1_i2 : i2
    %rst_sys_req_q = seq.firreg %c-1_i2 clock %7 reset async %8, %c-1_i2 : i2
    %state_d = seq.firreg %c55_i12 clock %7 reset async %8, %c0_i12 : i12
    %9 = comb.icmp ne %rst_sys_req_q, %c-1_i2 : i2
    %10 = comb.and %9, %strap_sampled_o : i1
    %strap_sampled_o = seq.firreg %10 clock %7 reset async %8, %false : i1
    ...
    %11 = comb.extract %reset_reqs_i from 0 : (i6) -> i5
    ...
    hw.output %false, %false, %false, %false, %false, %false, %false, %false, %0, %1, %u_reg_otp_init.q_o, %u_reg_lc_init.q_o, %false, %strap_sampled_o, %true, %u_fetch_en.lc_en_o : i1, i1, i1, i1, i1, i1, i1, i1, !hw.struct<rst_lc_req: i2, rst_sys_req: i2, rstreqs: i5, reset_cause: i2>, !hw.struct<main_ip_clk_en: i1, io_ip_clk_en: i1>, i1, i1, i1, i1, i1, i4
  }
