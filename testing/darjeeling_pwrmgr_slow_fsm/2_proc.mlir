module {
  hw.module @pwrmgr_slow_fsm(in %clk_i : i1, in %rst_ni : i1, in %rst_main_ni : i1, in %wakeup_i : i1, in %reset_req_i : i1, out req_pwrup_o : i1, out pwrup_cause_toggle_o : i1, out pwrup_cause_o : i2, in %ack_pwrup_i : i1, in %req_pwrdn_i : i1, out ack_pwrdn_o : i1, out rst_req_o : i1, out fsm_invalid_o : i1, in %clr_req_i : i1, in %main_pd_ni : i1, in %main_clk_en_i : i1, in %io_clk_en_i : i1, in %ast_i.slow_clk_val : i1, in %ast_i.core_clk_val : i1, in %ast_i.io_clk_val : i1, in %ast_i.main_pok : i1, out ast_o.main_pd_n : i1, out ast_o.pwr_clamp_env : i1, out ast_o.pwr_clamp : i1, out ast_o.slow_clk_en : i1, out ast_o.core_clk_en : i1, out ast_o.io_clk_en : i1) {
    ...
    %1 = comb.and %ast_i.core_clk_val, %ast_i.io_clk_val : i1
    %2 = comb.and %main_pd_ni, %main_clk_en_i : i1
    %3 = comb.and %main_pd_ni, %io_clk_en_i : i1
    %4 = comb.xor %ast_i.core_clk_val, %true : i1
    %5 = comb.or %2, %4 : i1
    %6 = comb.xor %ast_i.io_clk_val, %true : i1
    %7 = comb.or %3, %6 : i1
    %8 = comb.and %5, %7 : i1
    ...
    %cause_q = seq.compreg %120, %11 reset %12, %c0_i2 : i2  
    %cause_toggle_q = seq.compreg %125, %11 reset %12, %false : i1  
    %pd_nq = seq.compreg %122, %11 reset %12, %true : i1  
    %pwr_clamp_q = seq.compreg %127, %11 reset %12, %true : i1  
    %pwr_clamp_env_q = seq.compreg %129, %11 reset %12, %true : i1  
    %main_clk_en_q = seq.compreg %9, %11 reset %12, %false : i1  
    %io_clk_en_q = seq.compreg %10, %11 reset %12, %false : i1  
    %req_pwrup_q = seq.compreg %131, %11 reset %12, %false : i1  
    %ack_pwrdn_q = seq.compreg %133, %11 reset %12, %false : i1  
    %fsm_invalid_q = seq.compreg %135, %11 reset %12, %false : i1  
    %state_q = seq.compreg %119, %11 reset %12, %c34_i10 : i10  
    %13 = comb.icmp eq %state_q, %c34_i10 : i10
    %14 = comb.icmp eq %state_q, %c-313_i10 : i10
    %15 = comb.or %wakeup_i, %reset_req_i : i1
    %16 = comb.mux %reset_req_i, %c-2_i2, %c1_i2 : i2
    %17 = comb.icmp eq %state_q, %c431_i10 : i10
    %18 = comb.icmp eq %state_q, %c401_i10 : i10
    %19 = comb.icmp eq %state_q, %c-324_i10 : i10
    %20 = comb.mux %17, %u_main_pok_sync2Fu_sync_22Fq_o, %1 : i1
    %21 = comb.mux %17, %c401_i10, %c218_i10 : i10
    %22 = comb.or %17, %pd_nq : i1
    %23 = comb.xor %17, %true : i1
    %24 = comb.icmp eq %state_q, %c218_i10 : i10
    %25 = comb.icmp eq %state_q, %c-32_i10 : i10
    ...
    %34 = comb.icmp eq %state_q, %c117_i10 : i10
    %35 = comb.xor %req_pwrdn_i, %true : i1
    %36 = comb.icmp eq %state_q, %c-133_i10 : i10
    %37 = comb.xor %main_pd_ni, %true : i1
    %38 = comb.icmp eq %state_q, %c332_i10 : i10
    %39 = comb.xor %u_main_pok_sync2Fu_sync_22Fq_o, %true : i1
    ...
    %57 = comb.icmp ne %state_q, %c-503_i10 : i10
    ...
    %async_main_pok_st = seq.compreg %ast_i.main_pok, %11 reset %138, %false : i1  
    %139 = seq.to_clock %clk_i
    %140 = comb.xor %rst_ni, %true : i1
    %u_main_pok_sync2Fu_sync_12Fq_o = seq.compreg name "u_main_pok_sync/u_sync_1/q_o" %async_main_pok_st, %139 reset %140, %false : i1  
    %141 = seq.to_clock %clk_i
    %142 = comb.xor %rst_ni, %true : i1
    %u_main_pok_sync2Fu_sync_22Fq_o = seq.compreg name "u_main_pok_sync/u_sync_2/q_o" %u_main_pok_sync2Fu_sync_12Fq_o, %141 reset %142, %false : i1  
    %143 = comb.xor %122, %true : i1
    %144 = comb.and %143, %mon_main_pok : i1
    %145 = comb.or %136, %mon_main_pok : i1
    %146 = comb.xor %144, %true : i1
    %147 = comb.and %146, %145 : i1
    %148 = comb.or %144, %136 : i1
    %149 = comb.mux bin %148, %147, %mon_main_pok : i1
    %mon_main_pok = seq.compreg %149, %11 reset %12, %false : i1  
    %150 = comb.and %mon_main_pok, %39 : i1
    %151 = comb.or %rst_req_o, %150 : i1
    %152 = comb.xor %clr_req_i, %true : i1
    %153 = comb.and %152, %151 : i1
    %rst_req_o = seq.compreg %153, %11 reset %12, %false : i1  
    %154 = comb.xor %150, %true : i1
    verif.assert %154 : i1
    hw.output %req_pwrup_q, %cause_toggle_q, %cause_q, %ack_pwrdn_q, %rst_req_o, %fsm_invalid_q, %main_pd_n, %pwr_clamp_env, %pwr_clamp, %slow_clk_en, %core_clk_en, %io_clk_en : i1, i1, i2, i1, i1, i1, i1, i1, i1, i1, i1, i1
  }
}
